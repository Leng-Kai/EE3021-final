...
if __name__ == "__main__":
    ...
    #
    # Select the hihat characteristic
    #
    ...
    contents = peripheral.notify(service_uuid, characteristic_uuid, lambda data: hh(data))

    #
    # Select the crash characteristic
    #
    ...
    # Write the content to the characteristic
    contents = peripheral.notify(service_uuid, characteristic_uuid, lambda data: crash())
